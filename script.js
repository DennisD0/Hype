...
const startups = [
  {
    ...
    category: "Operations",
    description: "Voltline syncs factory telemetry with live war rooms so hardware founders can predict blockers before they hit production.",
  ...
  },
  {
    ...
    category: "Sales",
    description: "Beam turns every product drop into an immersive live studio with shoppable scenes, hosts, and real-time analytics.",
  ...
  },
  {
    ...
    // Cleaned single-file script.js - fully replaced content with no duplicates
    // Main DOM references
    const stream = document.getElementById("stream");
    const loading = document.getElementById("loading");
    const cardTemplate = document.getElementById("card-template");
