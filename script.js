...
index 0000000000000000000000000000000000000000..4404b1410542eabc8f99b7fae21f32c01c44c908
--- /dev/null
+++ b/script.js
@@ -0,0 +1,361 @@
...
+    category: "Community",
+    description: "Orbit curates mastermind circles, async coaching, and capital intros tailored for the earliest-stage teams.",
...
+    category: "AI",
+    description: "Outlier generates on-brand launch briefs, positioning, and content calendars in seconds with human-in-the-loop controls.",
...
+    category: "Analytics",
+    description: "Signal aggregates sentiment, roadmap risk, and retention health into a single dashboard for remote-first leadership teams.",
...
+    category: "Venture",
+    description: "Launchpad helps breakout creators spin up product lines with fractional ops, funding, and shared GTM playbooks.",
...
+    category: "Events",
+    description: "Neon Garden designs pop-up HQs where distributed teams gather for launches, offsites, and investor showcases.",
...
+    category: "Commerce",
+    description: "Afterglow packages lighting, scripting, and commerce overlays so founders can host compelling drops from anywhere.",
...
+    category: "Finance",
+    description: "Papertrail assembles diligence-ready data rooms with live metrics, stakeholder updates, and granular permissions.",
...
+    category: "Talent",
+    description: "Runway embeds curated talent partners who spin up full-stack hiring squads for the fastest growing companies.",
...
+    category: "Design",
+    description: "Palette crafts full brand identities, from logo to motion, using an AI engine trained on world-class creative direction.",
...
+    description: "Synced keeps every decision, update, and handoff in a living feed built for teams who sprint across timezones.",
...
+    category: "Climate",
+    description: "Zephyr models climate hardware performance and financing scenarios so teams can de-risk deployments pre-build.",
...
+    category: "Industry",
+    description: "Alloy connects product teams with modular manufacturing cells and instant capacity forecasting.",
...
+    category: "Creator",
+    description: "Prism visualizes conversion funnels, sponsorship revenue, and merch performance for modern creator businesses.",
...
+    category: "Proptech",
+    description: "Skyline scans global lease data and sentiment to pinpoint the best flexible office inventory for scaling teams.",
...
+    category: "XR",
+    description: "Driftspace spins up interactive demo worlds where launches and investor walkthroughs feel tactile and cinematic.",
...
+    category: "Marketing",
+    description: "Relay packages customer stories into episodic drops with cinematic editing and distribution workflows.",
...
+    category: "Security",
+    description: "Cipher hardens cloud infra with continuous monitoring, automated policy remediation, and human experts on call.",
...
+    category: "Finance",
+    description: "Hyperion blends CRM, billing, and product telemetry into predictive revenue models for leadership teams.",
...
+    category: "Influencer",
+    description: "Amplify tracks creator relationships, sends offers, and automates payouts for brand collab teams.",
...
+    category: "HR",
+    description: "Summit models comp scenarios across regions, equity bands, and growth plans so people teams stay ahead.",
...
+    description: "Momentum automates data pulls, narrative drafts, and stakeholder reminders for always-on investor comms.",
...
+    category: "Data",
+    description: "Vista merges surveys, commerce, and social data into a single lens so brands know what to build next.",
...
+    category: "Media",
+    description: "Echo runs rapid-fire creative tests across TikTok, Shorts, and Reels with AI clips that self-optimize.",
...
+    category: "DevTools",
+    description: "Flux keeps deploys green with predictive alerts, rollback recipes, and AI fix suggestions for on-call teams.",
...
+    category: "Community",
+    description: "Beacon pairs scouts with founders through curated signal drops, live matches, and shared diligence notes.",
...
+    const index = (cursor + i) % startups.length;
+    batch.push(startups[index]);
+  }
+  cursor += batchSize;
+  return batch;
+}
